        ...
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                        ...
                        @if (isset($categories) && count($categories) > 0)
                            @foreach ($categories as $category)
                                <a
                                        ...
                                        @click="open = false"
                                        class="flex items-center justify-between w-[338px] rounded-[12px] px-4 py-3 font-[Montserrat] font-medium text-[16px] leading-[100%] text-[#646464] hover:bg-gray-100 transition-colors"
                                >
                            ...
                            @endforeach
                                <a href="{{ route('products.index', ['category' => $category->slug]) }}"
                                        @click="open = false"
                                            class="flex items-center justify-between w-[338px] rounded-[12px] px-4 py-3 font-[Montserrat] font-medium text-[16px] leading-[100%] text-[#646464] hover:bg-gray-100 transition-colors mt-2 border-t border-gray-200"
                                    >
                ...
                <div class="relative w-[748px]" x-data="{ searchQuery: '' }">
                    ...
                    <button
                            @click="window.location.href = '/search?q=' + encodeURIComponent(searchQuery)"
                ...
                <a href="#" class="relative bg-[#FFF4E9] p-3 inline-flex items-center justify-center rounded-lg"
                   x-data="{ open: false }">
                    ...
                    <span x-show="$store.cart.count > 0"
                          ...
                          class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-semibold w-5 h-5 flex items-center justify-center rounded-full"
                    ...
                    <div x-show="open" @click.outside="open = false" x-transition
                         class="absolute  top-10 mt-2 w-96 bg-white shadow-lg rounded-xl p-4 z-50">
                                ...
                                <template x-for="item in $store.cart.items" :key="item.id">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <img :src="item.img" alt="" class="w-14 h-14 object-cover rounded-lg">
                                            <div>
                        ...
                        <div class="mt-4 border-t pt-3 flex justify-between items-center">
                            ...
                            <span class="font-bold text-lg" x-text="formatPrice($store.cart.items.reduce((total, i) => total + i.price * i.quantity, 0))"></span>
                        </div>
                    ...
                    <button @click.prevent="open = !open" class="absolute inset-0 w-full h-full"></button>
                </a>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            >
                                ...
                                <a
                                        ...
                                        class="flex items-center gap-2 px-4 py-3 rounded-[12px] text-gray-700 hover:bg-gray-100 transition-colors font-medium"
                                >
